      ...
      <div class="card-body">
        <form action="" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" placeholder="Ingrese código de barras" name="codigo" id="codigo" class="form-control" value="<?php echo $data_producto['codigo']; ?>" pattern="[0-9]+">
          </div>

          <div class="form-group">
            <label for="producto">Producto</label>
            <input type="text" class="form-control" placeholder="Ingrese nombre del producto" name="producto" id="producto" pattern="[A-Za-záéíóúñÁÉÍÓÚÑ\s]+" title="Este campo solo acepta letras y espacios">
          </div>
          <div class="form-group">

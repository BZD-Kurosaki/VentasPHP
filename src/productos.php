             ...
             <div class="modal-body">
                 <form action="" method="post" autocomplete="off">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" placeholder="Ingrese código de barras" name="codigo" id="codigo" class="form-control" pattern="[0-9]+">
                     </div>
                     <div class="form-group">
                         <label for="producto">Producto</label>
                         <input type="text" placeholder="Ingrese nombre del producto" name="producto" id="producto" class="form-control" pattern="[a-zA-Z ]+" title="Este campo solo acepta letras y espacios">
                     </div>
                     <div class="form-group">
                         <label for="precio">Precio</label>
                         <input type="text" placeholder="Ingrese precio" class="form-control" name="precio" id="precio" pattern="[0-9]+(\.[0-9]{1,2})?" title="Este campo solo acepta números y decimales separados por punto (por ejemplo, 12.34)">
                     </div>
